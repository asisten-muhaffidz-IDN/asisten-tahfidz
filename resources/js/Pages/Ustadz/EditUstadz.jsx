...
export default function EditUstadz({auth, dataUstadzSelected}) {
    console.log(dataUstadzSelected)



    const { data, setData, patch, errors } = useForm({
        nip: dataUstadzSelected.nip,
        nama: dataUstadzSelected.nama,
        status: dataUstadzSelected.status,
        posisi: dataUstadzSelected.posisi,
        jabatan: dataUstadzSelected.jabatan
    });
    ...
    const submit = async (e) => {
        ...
        try {
            patch(route('ustadz.update', dataUstadzSelected.id));
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                        <section>
                            <header>
                                <h2 className="text-lg font-medium text-gray-900">Edit Data Ustadz {dataUstadzSelected.nama}</h2>
                            </header>

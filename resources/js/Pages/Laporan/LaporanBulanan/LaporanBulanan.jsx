...
export default function LaporanBulanan({auth, dataHalaqoh}) {
    return (
        <Authenticated
            user={auth.user}
                ...
                <div className="w-full px-6 py-6 mx-auto">
                    <div className="flex flex-wrap -mx-3">
                        ...
                        (dataHalaqoh.map((dataHalaqoh, index) => (
                            <Link href={route('laporan.bulanan.create', dataHalaqoh.id)} key={dataHalaqoh.id} className="w-full max-w-full px-3 mb-6 transition duration-200 hover:scale-105 sm:w-1/2 sm:flex-none xl:w-1/3">

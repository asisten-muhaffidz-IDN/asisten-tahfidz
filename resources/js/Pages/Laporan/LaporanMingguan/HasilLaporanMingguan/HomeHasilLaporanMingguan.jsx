...
export default function HomeHasilLaporanMingguan({auth, dataHalaqoh}) {
    return (
        <Authenticated
            user={auth.user}
            header={'Hasil Laporan Mingguan'}
        >
            <Head title="Hasil Laporan Mingguan" />
                ...
                <div className="w-full px-6 py-6 mx-auto">
                    <div className="flex flex-wrap -mx-3">
                        ...
                        (dataHalaqoh.map((dataHalaqoh, index) => (
                            <Link key={dataHalaqoh.id} className="w-full max-w-full px-3 mb-6 transition duration-200 hover:scale-105 sm:w-1/2 sm:flex-none xl:w-1/3">
